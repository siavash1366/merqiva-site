const T = {
  ...
  ar: {
    ...
    bar4: "اقدام", bar4p: "أفضل إجراء مبيعات تالي",
    ...
    sh:
      "ليس فقط مَن تتواصل معه، بل لماذا يستحق التواصل معه الآن.",
    ...
    how: "كيف نعمل",
    howh: "من منتجاتك إلى المشترين المناسبين.",
    ...
    offerp:
      "خدمة بحث شهرية مركزة لموردي القطاع البحري الذين يستهدفون مشغلي السفن والمشترين في دول الخليج.",
